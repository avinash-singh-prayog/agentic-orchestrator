...
LangGraph workflow using tools for carrier operations.
"""
...
from .state import CarrierAgentState
from .nodes import CarrierNodes
...
class CarrierGraph:
    ...
    def _check_parse_result(self, state: CarrierAgentState) -> Literal["continue", "error"]:

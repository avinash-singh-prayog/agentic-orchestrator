"""
Carrier Agent Identity Card and Skills.
...
CarrierAgentCard = AgentCard(
    name='Carrier Agent',
    id='carrier-agent',  # This becomes the routable topic
    description='AI agent responsible for carrier operations: serviceability checks, rate quotes, and shipment booking.',
    ...
    skills=[
        AgentSkill(
            ...
            description="Check if shipping is available between two locations and retrieve available carriers.",

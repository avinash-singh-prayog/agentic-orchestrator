"""
Serviceability Service Settings.
...
class ServiceabilityAgentSettings(BaseSettings):
    """Configuration settings for the serviceability agent."""
    ...
    model_config = {
        "env_prefix": "SERVICEABILITY_AGENT_",
...
settings = ServiceabilityAgentSettings()

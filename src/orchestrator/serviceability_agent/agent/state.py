"""
Serviceability Agent State.

LangGraph state management for the serviceability agent workflow.
"""
...
class ServiceabilityAgentState(MessagesState):
    """
    State for the serviceability agent workflow.

    Extends MessagesState to include serviceability-specific state fields.
    """

    # Parsed shipment request from user input
    request: Optional[ShipmentRequest] = None

    # Available rates from all partners
